...
TimeFloatInterpolator::TimeFloatInterpolator(double initialValue) : value(initialValue), target(initialValue), duration(0.0f), elapsedTime(0.0f)
{
}

TimeFloatInterpolator::TimeFloatInterpolator(double initialValue, std::function<void()> callback) : value(initialValue), target(initialValue), duration(0.0f), elapsedTime(0.0f)
{
	_callbacks.push_back(callback);
}

TimeFloatInterpolator::TimeFloatInterpolator() : value(0),
